...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _XCOREAddress,
        address _WETHAddress,
        address _uniswapFactory
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        XCORETokenAddress = _XCOREAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(_uniswapFactory).getPair(WETHAddress,XCORETokenAddress);
        feePercentX100 = 11;
    ...
    address XCORETokenAddress;
    address XCOREVaultAddress;
    ...
    function setXCOREVaultAddress(address _XCOREVaultAddress) public onlyOwner {
        XCOREVaultAddress = _XCOREVaultAddress;
    }
    ...
    function calculateAmountsAfterFee(
        ...
        ) public  returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount)
        {
            ...
            if(sender == XCOREVaultAddress  || sender == tokenUniswapPair ) { // Dont have a fee when XCOREvault is sending, or infinite loop
